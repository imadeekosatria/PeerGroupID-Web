...
<div class="title">
    ...
    <table class="table-paginate">
      ...
      <tr>
        ...
        <td>
            <a href="/detail-artikel/<?php echo $data['slug']?>"><img src="/assets/images/launch.png" alt="" class="img-ikon"></a> <br>
            <!-- <a href="/admin-artikel/edit/"><img src="/assets/images/edit.png" alt="" class="img-ikon"></a> <br> -->
            <form action="/admin-artikel/edit/<?=$data['slug']?>" method="post">
              <?csrf_field();?>
              <input type="hidden" name="_method" value="PUT">
              <button type="submit" class="button-delete"><img src="/assets/images/edit.png" alt="" class="img-delete"></button>
            </form>
