...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 18 Nov 2021 pada 11.26
...
CREATE TABLE `user` (
  ...
  `foto` enum('male.png','female.png','default.png') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(1, 'usertes1', '1234', 'user tes haha', 'laki-laki', 'male.png'),
(2, 'imadeeko', '1234', 'I Made Eko Satria Wiguna', 'laki-laki', 'male.png');
